    ...
    SeosConfigLib_ParameterEnumerator* enumerator)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterEnumeratorInit(instance, domainEnumerator,
                                                     enumerator);
    }
    else
    {
    ...
    SeosConfigLib_Parameter* parameter)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterEnumeratorGetElement(instance, enumerator,
                                                           parameter);
    }
    else
    {
    ...
    SeosConfigLib_ParameterEnumerator* parameterEnumerator)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_domainCreateParameterEnumerator(instance, domain,
    ...
    SeosConfigLib_Parameter* parameter)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_domainGetElement(instance, domain, parameterName,
                                              parameter);
    }
    else
    {
    ...
    size_t* bytesCopied)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterGetValue(instance, parameter, buffer,
    ...
    size_t bufferLength)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterGetValueAsString(instance, parameter, buffer,
                                                       bufferLength);
    }
    else
    {
    ...
    size_t bufferLength)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterGetValueAsBlob(instance, parameter, buffer,
                                                     bufferLength);
    }
    else
    {
    ...
    size_t bufferLength)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterSetValue(instance, enumerator, parameterType,
                                               buffer, bufferLength);
    }
    else
    {
    ...
    size_t bufferLength)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterSetValueAsString(instance, enumerator,
    ...
    size_t bufferLength)
{
            ...
            handle))
    {
        SeosConfigLib* instance = (SeosConfigLib*)
                                  seos_configuration_handle_getLocalInstance(handle);
        return SeosConfigLib_parameterSetValueAsBlob(instance, enumerator,
                                                     parameterType, buffer, bufferLength);
    }
    else
    {
